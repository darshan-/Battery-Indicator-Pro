...
public class SettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public static final String KEY_EMPTY_PREF01 = "empty_pref01";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preference emptyPref01 = getPreferenceScreen().findPreference(KEY_EMPTY_PREF01);
        emptyPref01.setLayoutResource(R.layout.empty_pref);
